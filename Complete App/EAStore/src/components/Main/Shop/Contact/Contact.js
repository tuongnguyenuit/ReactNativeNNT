            ...
            <View style={wrapper}>
                ...
                <View style={infoContainer}>
                    <View style={rowInfoContainer}>
                        ...
                        <Text style={infoText}>University of Information Technology</Text>
                    </View>
                    
                    <View style={rowInfoContainer}>
                        <Image source={phoneIcon} style={imageStyle} />
                        <Text style={infoText}>(+84) 169.678.3735</Text>
                    </View>

                    <View style={rowInfoContainer}>
                        <Image source={mailIcon} style={imageStyle} />
                        <Text style={infoText}>tuong.nguyenngoc.nnt@gmail.com</Text>
                    </View>
